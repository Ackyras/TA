...
class KoorRegionManagementTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        parent::setUp();
        $this->actingAs(User::whereRelation('roles', 'roles.name', 'koor')->first());
    }
    ...
    public function test_kepala_dinas_can_add_village()
    {
        ...
        $newVillage = District::where('name', $villageData)->first();
